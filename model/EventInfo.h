...
public:
    ...
    void setEqualDynamicTransitionInfo(const String& port_name_);
    void setTransitionInfo0(const String& port_name_);
    void setTransitionInfo00(const String& port_name_);
    void setTransitionInfo11(const String& port_name_);
