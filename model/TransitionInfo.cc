...
TransitionInfo::TransitionInfo(double number_transitions_00_, double number_transitions_01_, double number_transitions_10_,
                               double number_transitions_11_)
    : m_number_transitions_00_(number_transitions_00_), m_number_transitions_01_(number_transitions_01_),
      m_number_transitions_10_(number_transitions_10_), m_number_transitions_11_(number_transitions_11_)
{
    m_frequency_multiplier_ = m_number_transitions_00_ + m_number_transitions_10_ + m_number_transitions_01_ + m_number_transitions_11_;
    update1();
}
...
void TransitionInfo::update1()
{
    ASSERT(m_number_transitions_00_ >= 0.0, "[Error] Number of 0->0 transitions (" +
           (String)m_number_transitions_00_ + ") must be >= 0.0!");
    ASSERT(m_number_transitions_01_ >= 0.0, "[Error] Number of 0->1 transitions (" +
           (String)m_number_transitions_01_ + ") must be >= 0.0!");
    ASSERT(m_number_transitions_10_ >= 0.0, "[Error] Number of 1->0 transitions (" +
           (String)m_number_transitions_10_ + ") must be >= 0.0!");
    ASSERT(m_number_transitions_11_ >= 0.0, "[Error] Number of 1->1 transitions (" + (String)m_number_transitions_11_ + ") must be >= 0.0!");

    m_probability_1_ = (m_number_transitions_01_ / 2 + m_number_transitions_11_ + m_number_transitions_10_ / 2) / m_frequency_multiplier_;
    m_probability_0_ = 1.0 - m_probability_1_;
    return;
}
