...
public:
    ...
    TransitionInfo(double number_transitions_00_, double number_transitions_01_, double number_transitions_10_, double number_transitions_11_);
    ~TransitionInfo();
...
public:
    ...
    inline double getNumberTransitions10() const { return m_number_transitions_10_; }
    ...
    inline double getProbability0() const { return m_probability_0_; }
...
private:
    ...
    double m_number_transitions_10_;
